...
>	
>	>(2): Neutrality: We tried two variants of an attribute that could be called "neutrality" and checked for some specific examples (f_1 - f_6), which satisfies which variant
>	
